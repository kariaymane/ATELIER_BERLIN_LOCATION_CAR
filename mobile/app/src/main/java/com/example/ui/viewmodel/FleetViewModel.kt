...
class FleetViewModel(
    ...
    private val _navigationStack = MutableStateFlow<List<Screen>>(listOf(Screen.Auth))
    ...
    val currentScreen: StateFlow<Screen> = _navigationStack.map { it.lastOrNull() ?: Screen.Auth }
