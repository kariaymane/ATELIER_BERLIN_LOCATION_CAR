            ...
            for item in items:
                ...
                if etype == "vehicle":
                    ...
                    if op == "DELETE":
                        ...
                        c.address = payload.get("address", getattr(c, 'address', None))
                        ...
                        c.contract_image = payload.get("contract_image", getattr(c, 'contract_image', None))
        ...
        try:
            ...
            try:
                ...
                for c_dto in server_clients:
                    ...
                    c.contract_image = c_dto.get("contract_image")
