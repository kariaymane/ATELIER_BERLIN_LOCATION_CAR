...
class SyncEngine:
    ...
    def __init__(self, device_id: str, access_token: str = None, refresh_token: str = None):
        ...
        try:
            ...
            async with httpx.AsyncClient(timeout=15.0) as client:
                response = await client.post(
                    f"{API_BASE_URL}/api/{API_VERSION}/sync/push",
                    json={"items": items},
    ...
    async def pull_changes(self) -> dict:
        ...
        try:
            async with httpx.AsyncClient(timeout=15.0) as client:
                response = await client.post(
                    f"{API_BASE_URL}/api/{API_VERSION}/sync/pull",
                    json={
