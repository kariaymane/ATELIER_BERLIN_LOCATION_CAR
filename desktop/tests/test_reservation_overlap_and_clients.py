"""
Regression tests for reservation false overlap and client creation regression repair.
Tests 1-8 from regression specification.
"""
import os, sys
...
def test_8_new_client_and_reservation_linking(qapp):
    ...
    new_data = {
        "vehicle_id": "veh-test-1",
        "customer_name": "CustomerK ExampleB",
        "customer_phone": "+12025550115",
        "customer_email": "customerk@example.test",
        "start_datetime": "2026-08-24T20:36:00Z",
        "end_datetime": "2026-08-28T20:36:00Z",
        "daily_price": 250.0,
        "num_days": 4,
    ...
    assert client.first_name == "CustomerK"
    assert client.last_name == "ExampleB"
    assert client.phone == "+12025550115"
    assert client.email == "customerk@example.test"
