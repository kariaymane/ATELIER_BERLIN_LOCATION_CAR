...
NEW RESERVATION -> regressionBrand ProofModel -> 24/08/2026 21:36 -> 28/08/2026 21:36 ->
...
def test_full_physical_ui_flow():
    ...
    # 4. Open New Reservation for regressionBrand ProofModel
    v_dict = {
        "id": "fb-proof-real-1",
        "brand": "regressionBrand",
        "model": "ProofModel",
    ...
    res_data = {
        ...
        "customer_id": None,
        "customer_name": "CustomerQ ExampleG",
        "customer_phone": "+12025550122",
        "customer_email": "customerq@example.test",
        "identity_card_image": "",
    ...
    created_client = [c for c in local_clients if "ExampleG" in c["last_name"] or "CustomerQ" in c["first_name"]]
