...
event.listen(
    Reservation.__table__,
    "after_create",
    _create_sqlite_trigger.execute_if(dialect="sqlite"),
)

_create_sqlite_trigger_update = DDL("""
...
event.listen(
    Reservation.__table__,
    "after_create",
    _create_sqlite_trigger_update.execute_if(dialect="sqlite"),
)
